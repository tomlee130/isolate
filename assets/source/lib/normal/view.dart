...
import 'dart:async';
import 'counter_normal.dart';

class NormalCounterPage extends StatefulWidget {
  const NormalCounterPage({super.key});

  @override
  State<NormalCounterPage> createState() => _NormalCounterPageState();
}

class _NormalCounterPageState extends State<NormalCounterPage> {
  final NormalCounter _counter = NormalCounter();
